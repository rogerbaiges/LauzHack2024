...
class ImageSegmenter:
	...
	def segment(self, image, text):
		...
		return f'There have been segmented a total of {self.count_masks()} of "{text}" in the image.', segmented_image_path
	...
	def find_similar_objects(self, image_path):
		...
		if similar_regions:
			...
			print("No similar features found.")
		return f'Similar objects have been found in the image.', output_image_path
